...
boost::shared_ptr<VisionaryTMiniData> gDataHandler;
...
void thr_receive_frame(boost::shared_ptr<VisionaryDataStream> pDataStream, boost::shared_ptr<VisionaryTMiniData> pDataHandler)
{
    while (gReceive)
    {
...
int main(int argc, char **argv) {
    ...
    boost::shared_ptr<VisionaryTMiniData> pDataHandler = boost::make_shared<VisionaryTMiniData> ();
