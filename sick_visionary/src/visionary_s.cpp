...
boost::shared_ptr<VisionarySData> gDataHandler;
...
void thr_receive_frame(boost::shared_ptr<VisionaryDataStream> pDataStream, boost::shared_ptr<VisionarySData> pDataHandler)
{
    while (gReceive)
    {
